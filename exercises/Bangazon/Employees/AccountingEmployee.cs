...
{
    public class AccountingEmployee: Employee, IFullTime, IPartTime
    {
        // Field
        ...
        // Constructor
        public AccountingEmployee() : base()
        {
            Console.WriteLine("Enter Accounting employee's first name: "); 
            	this.FirstName = Console.ReadLine();
            Console.WriteLine("Enter Accounting last name: ");
            ...
            if (workStatus.ToUpper() == "FT")
            {
			    ...
			    Console.WriteLine("Accounting employee: {0}, {1}, {2}, {3:C}",this.FirstName,this.LastName,workStatus,this.HourlyRate);
            }
        }

        public AccountingEmployee(string firstName, string lastName, string jobStatus, double pay) : base(firstName, lastName)
        {
        ...
        public override void printEmployee()
        {
            if (Salary != 0) 
            {
                Console.WriteLine($"Accounting employee name: {this.FirstName} {this.LastName} | Yearly salary: {(this.Salary):C}");
            } else 
            {
                Console.WriteLine($"Accounting employee name: {this.FirstName} {this.LastName} | Hourly rate: {(this.HourlyRate):C}");
            }
        }
